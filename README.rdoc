...
What I Did
I used my newly acquired knowledge of HTML & CSS to re-create Google's homepage! I primarily modeled Jenny's LinkedIn example and also incorporated some information I learned by inspecting some of Google's elements. I created many different div's and classes to allow CSS to collectively style. This was actually pretty fun!
